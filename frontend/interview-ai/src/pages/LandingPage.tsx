          ...
          <div className="flex flex-col items-start">
            ...
            <div className="w-full max-w-xl">
              <p className="text-[17px] text-gray-900 mr-0 mb-6">
                This application is designed to help you prepare for interviews
                by providing you with a platform to practice your interview
                skills. The app uses AI technology to simulate real interview
                scenarios, allowing you to practice answering questions and
                receive feedback on your performance. This is a personal
                project, and I might make more improvements in the near future.
              </p>
